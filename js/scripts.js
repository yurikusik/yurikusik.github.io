...
(function($) {
	...
	----------------------------------------------------- */
	$(".typed-element").typed({
    	strings: ["Performance Tester", "Automation Tester", "Manual Tester", "Software Quality Enginner"],
    	typeSpeed: 10,
    	loop:true,
    	backDelay: 2000
    });
	...
	// 		e.preventDefault();
			...
			form.addEventListener("submit", function (e) {
				setTimeout(function() {
					...
					formResponse.text("Thanks! Your message sent correctly.").fadeIn(15000);
				}, 1);
	...
	if(getURL.includes('Successfully')){
		console.log('ok')
		var formResponse = $(".form-response");
		formResponse.text("Thanks! Your message sent correctly.").fadeIn(15000);
	}
